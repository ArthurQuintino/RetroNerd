...
class Games {
  ...
  Games(this.nome, this.desc, this.imagem, this.imagemExtra, this.extra,
      this.produtora, this.console);
}
...
List<Produtoras> produtoras = [
  Produtoras(
      'PlayStation',
      'PlayStation é uma das marcas mais icônicas no mundo dos videogames. Desde seu lançamento, revolucionou o mercado com consoles poderosos, experiências gráficas impressionantes e uma biblioteca vasta de jogos que moldaram gerações de jogadores.',
      'assets2/produtoras/ps.png'),
  Produtoras(
      'Nintendo',
      'Nintendo é sinônimo de inovação e diversão no mundo dos games. Criadora de algumas das franquias mais amadas, como Mario, Zelda e Pokémon, a empresa combina tecnologia única com experiências de jogo memoráveis.',
      'assets2/produtoras/nintendo.png'),
  Produtoras(
      'Sega',
      'Sega é uma produtora histórica que marcou os anos 80 e 90 com consoles revolucionários e franquias inesquecíveis como Sonic the Hedgehog. É lembrada como uma pioneira na indústria de jogos.',
      'assets2/produtoras/sega.png')
];

List<Videogames> consoles = [
  Videogames(
      'PS1',
      'O PlayStation 1 foi um marco na história dos videogames, trazendo gráficos em 3D, uma biblioteca repleta de clássicos como Final Fantasy VII e Resident Evil, além de popularizar o uso de CDs como mídia de armazenamento.',
      "assets2/consoles/Playstation/ps1_2.png",
      "assets2/consoles/Playstation/ps1.png"),
  Videogames(
      'PS2',
      'O PlayStation 2 é o console mais vendido de todos os tempos, com uma biblioteca vasta que inclui clássicos como GTA: San Andreas, Shadow of the Colossus e God of War. Revolucionou o mercado com gráficos avançados e suporte a DVDs.',
      "assets2/consoles/Playstation/ps2_logo.png",
      "assets2/consoles/Playstation/ps2_1.png"),
  Videogames(
      'Nintendo DS',
      'O Nintendo DS inovou com suas duas telas, sendo uma delas sensível ao toque. Jogos como Pokémon HeartGold/SoulSilver e New Super Mario Bros redefiniram o conceito de portáteis.',
      "assets2/consoles/Nintendo/ds_logo.png",
      "assets2/consoles/Nintendo/ds_portatil.png"),
  Videogames(
      'Nintendo 3DS',
      'O Nintendo 3DS introduziu gráficos 3D sem a necessidade de óculos especiais e trouxe títulos inesquecíveis como Fire Emblem Awakening, Pokémon X e Animal Crossing: New Leaf.',
      "assets2/consoles/Nintendo/3ds_logo.png",
      "assets2/consoles/Nintendo/3ds_portatil.png"),
  Videogames(
      'Mega Drive',
      'O Sega Mega Drive (Genesis) é lembrado por sua velocidade e títulos incríveis como Sonic the Hedgehog 2, Streets of Rage e Golden Axe.',
      "assets2/consoles/Sega/megadrive_logo.png",
      "assets2/consoles/Sega/megadrive_console.png"),
  Videogames(
      'Sega Dreamcast',
      'O Sega Dreamcast foi pioneiro em trazer a experiência de jogo online e apresentou títulos revolucionários como Shenmue, Crazy Taxi e Phantasy Star Online.',
      "assets2/consoles/Sega/Dreamcast_logo.png",
      "assets2/consoles/Sega/Dreamcast_console.png")
];
